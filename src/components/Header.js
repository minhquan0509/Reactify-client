...
export default function Header(){
    return (
        <div className="d-flex justify-content-between position-sticky top-0 py-2">
            <div>
            ...
            <div className='d-flex justify-content-between align-items-center p-1' style={{cursor: 'pointer',backgroundColor: '#050806', borderRadius: '15px'}}>
